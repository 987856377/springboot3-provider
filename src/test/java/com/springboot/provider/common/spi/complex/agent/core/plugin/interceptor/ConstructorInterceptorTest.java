...
import com.springboot.provider.common.spi.complex.agent.core.mock.material.ConstructorMaterial;
...
public final class ConstructorInterceptorTest {
    ...
    public void assertNoArgConstructor() {
        assertThat(new ConstructorMaterial(new ArrayList<>()), instanceOf(AdviceTargetObject.class));
    }
