...
import com.springboot.provider.common.spi.complex.agent.core.mock.material.InstanceMaterial;
...
public final class InstanceMethodAroundInterceptorTest {
    ...
    public InstanceMethodAroundInterceptorTest(boolean rebase, String methodName, String result, String[] expected) {
        this.rebase = rebase;
    ...
    public void assertInterceptedMethod() throws ReflectiveOperationException {
        ...
        if ("mockWithException".equals(methodName)) {
            ...
            MatcherAssert.assertThat(material.mock(queues), is(result));
        }
