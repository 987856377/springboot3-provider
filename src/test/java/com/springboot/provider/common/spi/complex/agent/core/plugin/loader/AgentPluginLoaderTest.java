...
package com.springboot.provider.common.spi.complex.agent.core.plugin.loader;
...
public final class AgentPluginLoaderTest {
    ...
    private static final TypeDescription MATERIAL = POOL.describe("com.springboot.provider.common.spi.agent.complex.core.mock.material.Material").resolve();
