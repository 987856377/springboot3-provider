...
import com.springboot.provider.common.spi.complex.agent.core.mock.material.StaticMaterial;
...
public final class ClassStaticMethodAroundInterceptorTest {
    ...
    public ClassStaticMethodAroundInterceptorTest(String methodName, String result, String[] expected) {
    ...
    public void assertInterceptedMethod() {
        ...
        if ("staticMockWithException".equals(methodName)) {
            ...
            MatcherAssert.assertThat(StaticMaterial.staticMock(queues), is(result));
        }
